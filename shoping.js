...
const products = [
  {
    ...
    title: "iphone X",
    imgUrl:
      "https://s.yimg.com/os/creatr-uploaded-images/2018-10/e0186290-d3a1-11e8-a877-3edaad41fc41",
    quantity: 5,
    price: 74000,
    inCart: false,
    info: `64 GB ROM 
  ...
  },
  {
    ...
    title: "redmi note 9",
    imgUrl:
      "https://i01.appmifile.com/webfile/globalimg/in/cms/8CF60072-6762-E5F5-BA0D-1F4BB6AE26C4.jpg",
    quantity: 2,
    price: 12000,
    inCart: false,
    info: `4 GB RAM | 128 GB ROM | Expandable Upto 512 GB
  ...
  },
  {
    ...
    title: "realme 7",
    imgUrl:
      "https://static.toiimg.com/thumb/msid-78107023,width-1200,resizemode-4/78107023.jpg",
    quantity: 10,
    price: 14000,
    inCart: false,
    info: `6 GB RAM | 64 GB ROM | Expandable Upto 256 GB
  ...
  },
  {
    ...
    title: "poco m2 pro",
    imgUrl:
      "https://www.gizmochina.com/wp-content/uploads/2020/07/POCO-M2-Pro-featured.png",
    quantity: 1,
    price: 10000,
    inCart: false,
    info: `4 GB RAM | 64 GB ROM | Expandable Upto 512 GB
      16.94 cm (6.67 inch) Full HD+ Display
      48MP + 8MP + 5MP + 2MP | 16MP Front Camera
  ...
  },
  {
    ...
    title: "men shirt",
    imgUrl:
      "https://www.dhresource.com/0x0/f2/albu/g8/M00/27/59/rBVaV13oWXuAPSh_AAJO6__js5M100.jpg/spring-light-blue-men-shirt-fashion-mens.jpg",
    quantity: 5,
    price: 400,
    inCart: false,
    info: `Care Instructions: Machine Wash
  ...
  },
  {
    ...
    title: "men t-shirt",
    imgUrl:
      "https://i.pinimg.com/736x/e9/8d/44/e98d449dca79f830ec0f0e242397d8ae.jpg",
    quantity: 2,
    price: 350,
    inCart: false,
  ...
  },
  {
    ...
    title: "women jacket",
    imgUrl:
      "https://i.pinimg.com/originals/73/f8/57/73f857050959990f6af9f2a9175b765e.png",
    quantity: 1,
    price: 1200,
    inCart: false,
    info: `Care Instructions: hand wash
      Color Name: Pink
      100% Nylon
      Hand wash
      Quilted
  ...
  },
  {
    ...
    title: "bat",
    imgUrl:
      "https://images-na.ssl-images-amazon.com/images/I/71qjE2I%2BO7L._SL1500_.jpg",
    quantity: 5,
    price: 900,
    inCart: false,
    info: `Brand	Kansal Traders
      Color	Red
  ...
  },
  {
    ...
    title: "foot ball",
    imgUrl:
      "https://m.media-amazon.com/images/I/31XMtxBt53L.jpg",
    quantity: 2,
    price: 650,
    inCart: false,
    info: `Colour : Multicolor
  ...
  },
  {
    ...
    title: "badminton",
    imgUrl:
      "https://images-na.ssl-images-amazon.com/images/I/61cGtO5ieML._SL1500_.jpg",
    quantity: 3,
    price: 800,
    inCart: false,
    info: `Ideal for junior, age group above 4 years,
  ...
  },
  {
    ...
    price: 1200,
    inCart: false,
    info: `Included Components: Two 10kg rubber coated round dumbbells
  ...
  },
  {
    ...
    title: "trimmer",
    imgUrl:
      "https://images.philips.com/is/image/PhilipsConsumer/BT3102_15-IMS-en_IN?$jpglarge$&wid=1250",
    quantity: 5,
    price: 900,
    inCart: false,
    info: `This trimmer has high precision blades Please use
  ...
  },
  {
    ...
    title: "digital watch",
    imgUrl:
      "https://www.skmei-watch.com/wp-content/uploads/2019/10/16016-8o0yas.jpg",
    quantity: 2,
    price: 650,
    inCart: false,
    info: `Dial color: black, case shape: round, dial glass material: mineral
  ...
  },
  {
    ...
    title: "camera",
    imgUrl:
      "https://media.wired.com/photos/5b64db3717c26f0496f4d62d/master/w_1982,h_1486,c_limit/Canon-G7XII-SOURCE-Canon.jpg",
    quantity: 3,
    price: 25000,
    inCart: false,
    info: `Sensor: APS-C CMOS Sensor with 24.1 MP 
  ...
  },
  {
    ...
    price: 12000,
    inCart: false,
    info: `26.31 Centimeters (10.4-inch) ,
      16M color support
  ...
  },
  {
    ...
    title: "bean bag",
    imgUrl:
      "https://5.imimg.com/data5/PE/AS/MY-37550917/gabbroo-bean-bag-brown-500x500.jpeg",
    quantity: 5,
    price: 900,
    inCart: false,
    info: `Pack Contents - 1 Bean Bag Cover without beans
  ...
  },
  {
    ...
    title: "table",
    imgUrl:
      "https://www.ikea.com/ca/en/images/products/ingo-table-pine__0737092_PE740877_S5.JPG",
    quantity: 2,
    price: 3000,
    inCart: false,
    info: `Specification: Package Content:-Set of 6 table mats & 1 Long Runner,
  ...
  },
  {
    ...
    title: "curtains",
    imgUrl:
      "https://www.meijer.com/content/dam/meijer/product/0088/53/0846/60/0088530846601_1_A1C1_1200.png",
    quantity: 3,
    price: 500,
    inCart: false,
    info: `Color: ivory & ivory, size name: standard
      Material: polyester
  ...
  },
  {
    ...
    title: "wall clocks",
    imgUrl:
      "https://www.ikea.com/in/en/images/products/bravur-wall-clock-black__0633568_PE695902_S5.JPG",
    quantity: 2,
    price: 700,
    inCart: false,
    info: `Dial size: 11.75 inches in diameter
...
document.addEventListener("DOMContentLoaded", () => {
  ...
  let cart = [];
  // ====== FOR VIEW ALL THE PRODUCTS ======
  displayProducts(products);

  // ====== FOR VIEW SEARCHED PRODUCTS ======
  document.getElementById("searchButton").addEventListener("click", searchProduct);
  function searchProduct() {
    const searchInput = document.getElementById("searchInput").value.toLowerCase();
    const filteredProduct = products.filter((product) => {
      const nameMatches = product.title.toLowerCase().includes(searchInput);
      const categoryMatches = product.category.toLowerCase().includes(searchInput);
  ...
  function filterProducts() {
    ...
    const selectedCheckBox = Array.from(filterInput).map(
      (checkbox) => checkbox.id
    );
    const selectedCheckBoxProducts = products.filter((product) => {
      const productCategory = product.category;
      const productPrice = product.price;
      const selectedPriceRange = priceRange.value;
      if (
        (selectedCheckBox.includes(productCategory) ||
    ...
    displayProducts(selectedCheckBoxProducts);
  }

  // ====== FOR PRICE RANNGE VALUE CHANGE ======
  priceRange.addEventListener("input", () => {
    priceValue.textContent = priceRange.value;
  });

  // ====== FOR RESET FILTER PRODUCTS ======
  ...
  function resetValues() {
    ...
    priceValue.textContent = priceRange.max / 2;
  ...
  function addToCartEvent() {
    const productId = parseInt(addToCart.dataset.productId, 10);
  ...
  function updateCartUI() {
    ...
    document.querySelector('.cartPrice').textContent=cart.length;
    ...
    cart.forEach((item) => {
      ...
      cartItem.innerHTML = `
            <div class="d-flex justify-content-between align-items-center mb-3">
                <img src="${item.imgUrl}" alt="${item.title}" style="width: 50px; height: 50px; object-fit: cover;">
                <div>
                    <h6>${item.title}</h6>
                    <p>₹${item.price}</p>
                </div>
  ...
  // ====== FOR TOGGLE CART SLIDER ======
  cartIcon.addEventListener("click", toggleCart);
  function toggleCart() {
    document.getElementById("cartSlider").classList.toggle("show");
  }

  // ====== FOR CART CLOSE =====
  document.getElementById("cartCloseIcon").addEventListener("click", () => {
    document.getElementById("cartSlider").classList.remove("show");
  });

  // ====== FOR REMOVE ALL PRODUCT FROM CART ======
...
// ---- Display all the products from given array ----
const displayProducts = (products) => {
  const productList = document.getElementById("productIdList");
  productList.innerHTML = "";
  products.forEach((product) => {
    const productCards = document.createElement("div");
    productCards.className = "col-md-4";
    productCards.innerHTML = `
        <div class = "card mt-3 shadow" data-product-id="${product.id}">
    ...
    productCards.addEventListener("click", () => viewDetails(product));
  });
};

const viewDetails = (product) => {
  const modalList = new bootstrap.Modal(
    document.getElementById("productDetails")
  );
  document.getElementById("modalImg").src = product.imgUrl;
  ...
  document.getElementById("modalInfo").textContent =
    product.info || "NO Additional details are available.";
